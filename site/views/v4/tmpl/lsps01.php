...
class lsps01App extends Tsjdf_libros2HelpersBook2ExtJSApp{

    public  $txt_field2352 = '';
            
    function getViewInitialConditions() {
        $obj = parent::getViewInitialConditions();
        $obj->txt_field2352 = $this->txt_field2352;
        return $obj;
    }
}

$bookApp = new lsps01App($this->libro, $this->empleado);
...
if($this->empleado->id_secretaria AND $magistradop){
        $bookApp->txt_field2352 = $magistradop->txt;
}
