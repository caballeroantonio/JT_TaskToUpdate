...
<div class="jtca lsps14-edit<?php echo $this->escape($params->get('pageclass_sfx')); ?>">
	<?php if ($params->get('show_page_heading')) : ?>
		<div class="page-header">
			<h1><?php echo $this->escape($params->get('page_heading')); ?></h1>
		</div>
	<?php endif; ?>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsps14form&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lsps14-form" class="form-validate">
		<div class="btn-toolbar">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Joomla.submitbutton('lsps14.save')">
					<span class="icon-ok"></span>&#160;<?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Joomla.submitbutton('lsps14.cancel')">
			...
			<?php if (
				  ...
				  AND $params->get('lsps14_save_history')
			) : ?>
				<div class="btn-group">
...
<?php */?>
					...
					<?php foreach($this->form->getFieldset('fieldset_lsps14_fs') as $field): ?>
						<?php if (!$field->hidden) : ?>
...
<?php /*?>
						...
						<?php else: ?>
							<div class="form-note">
								<p><?php echo JText::_('COM_JTCA_LSPS14S_ORDERING'); ?></p>
							</div>
						<?php endif; ?>
<?php */?>
...
<?php /*?>			<ul class="nav nav-tabs">
				<li class="active"><a href="#basic-details" data-toggle="tab"><?php echo JText::_('COM_JTCA_LSPS14S_FIELDSET_DETAILS_LABEL');?></a></li>
				<li><a href="#fieldset-lsps14_fs" data-toggle="tab"><?php echo JText::_('COM_JTCA_LSPS14S_FIELDSET_LSPS14_FS_LABEL');?></a></li>
			...
			<div class="tab-content">
				...
				<input type="hidden" name="form_id" id="form_id" value="lsps14-form" />
