...
$function	= $app->input->get('function', 'jSelectLsps08');
 ...
 */
?>
<div class="lsps08s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LSPS08S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsps08s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lsps08_add_link', 1) AND $can_create)
	echo JHtml::_('lsps08icon.create', $this->params);
?>
