...
$function	= $app->input->get('function', 'jSelectLsps07');
 ...
 */
?>
<div class="lsps07s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LSPS07S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsps07s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lsps07_add_link', 1) AND $can_create)
	echo JHtml::_('lsps07icon.create', $this->params);
?>
