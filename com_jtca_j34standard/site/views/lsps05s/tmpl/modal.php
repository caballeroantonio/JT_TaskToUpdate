...
$function	= $app->input->get('function', 'jSelectLsps05');
 ...
 */
?>
<div class="lsps05s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LSPS05S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsps05s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lsps05_add_link', 1) AND $can_create)
	echo JHtml::_('lsps05icon.create', $this->params);
?>
