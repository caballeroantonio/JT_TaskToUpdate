...
$function	= $app->input->get('function', 'jSelectLsps06');
 ...
 */
?>
<div class="lsps06s-modal<?php echo $this->params->get('pageclass_sfx');?>">
	<h3><?php echo JText::_('COM_JTCA_LSPS06S_SELECT_ITEM_LABEL'); ?></h3>
	<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsps06s&layout=modal&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
...
if ($this->params->get('show_lsps06_add_link', 1) AND $can_create)
	echo JHtml::_('lsps06icon.create', $this->params);
?>
