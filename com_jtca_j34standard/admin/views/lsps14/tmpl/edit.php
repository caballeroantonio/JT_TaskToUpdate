...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsps14&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lsps14-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lsps14-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lsps14-tabs', 'details', JText::_('COM_JTCA_LSPS14S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lsps14-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lsps14-tabs', 'fieldset-lsps14_fs', JText::_('COM_JTCA_LSPS14S_FIELDSET_LSPS14_FS_LABEL', true)); ?>
