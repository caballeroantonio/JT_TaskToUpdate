...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsps08&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lsps08-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lsps08-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lsps08-tabs', 'details', JText::_('COM_JTCA_LSPS08S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lsps08-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lsps08-tabs', 'fieldset-lsps08_fs', JText::_('COM_JTCA_LSPS08S_FIELDSET_LSPS08_FS_LABEL', true)); ?>
