...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsps13&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lsps13-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lsps13-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lsps13-tabs', 'details', JText::_('COM_JTCA_LSPS13S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lsps13-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lsps13-tabs', 'fieldset-lsps13_fs', JText::_('COM_JTCA_LSPS13S_FIELDSET_LSPS13_FS_LABEL', true)); ?>
