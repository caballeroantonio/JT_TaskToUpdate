...
<form action="<?php echo JRoute::_('index.php?option=com_jtca&view=lsps09&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="lsps09-form" class="form-validate">

	<!-- Begin Content -->
	<div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'lsps09-tabs', array('active' => 'details')); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lsps09-tabs', 'details', JText::_('COM_JTCA_LSPS09S_FIELDSET_DETAILS_LABEL', true)); ?>
			<div class="row-fluid">
				<div class="span3">
			...
			<?php echo JHtml::_('bootstrap.addTab', 'lsps09-tabs', 'publishing', JText::_('COM_JTCA_FIELDSET_PUBLISHING_LABEL', true)); ?>
				...
				<?php endif; ?>
                    <?php
					 ...
					 ?>
			<?php echo JHtml::_('bootstrap.endTab'); ?>
			<?php echo JHtml::_('bootstrap.addTab', 'lsps09-tabs', 'fieldset-lsps09_fs', JText::_('COM_JTCA_LSPS09S_FIELDSET_LSPS09_FS_LABEL', true)); ?>
