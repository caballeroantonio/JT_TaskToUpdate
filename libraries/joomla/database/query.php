...
abstract class JDatabaseQuery
{
	...
	/**
	 * Add a table name to the DELETE clause of the query. USED BY com_tsjdf_libros2\controllers\v5.php
	 *
	 * Note that you must not mix insert, update, delete and select method calls when building a query.
	 *
	 * Usage:
	 ...
	 * @param   string  $table  The name of the table to delete from.
         * 
         * @param array $elements alias to do delete join, example: DELETE a,b FROM table a JOIN table b
	 *
	 * @return  JDatabaseQuery  Returns this object to allow chaining.
	 *
	 * @since   11.1
	 */
	public function delete_alias($table = null, $elements = null)
	{
		$this->type = 'delete';
