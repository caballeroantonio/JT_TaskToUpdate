...
<div class="container-popup">
	...
	<div class="btn-group pull-right">
            <?php 
            if ($user->authorise('load', 'com_contenthistory')):
?>
...
<?php
            ...
            if ($user->authorise('preview', 'com_contenthistory')): 
?>
...
<?php 
            ...
            if ($user->authorise('compare', 'com_contenthistory')): 
?>
...
<?php 
            ...
            if ($user->authorise('keep', 'com_contenthistory')): 
?>
...
<?php 
            ...
            if ($user->authorise('core.delete', 'com_contenthistory')): 
?>
				...
				<tr>
					...
					<th width="15%" class="nowrap hidden-phone">
						<?php echo JText::_('COM_CONTENTHISTORY_VERSION_NOTE'); ?>
                                        ...
                                        <?php if($user->authorise('keep', 'com_contenthistory')): ?>
